---
id: 25288
title: "Funding What Matters in the Age of AI"
slug: funding-what-matters-in-the-age-of-ai
category: open-discussion
url: https://gov.gitcoin.co/t/funding-what-matters-in-the-age-of-ai/25288
created_at: 2026-06-01T00:25:59.925Z
last_posted_at: 2026-06-08T16:49:50.193Z
posts_count: 3
views: 79
like_count: 8
---
...
<https://gov.gitcoin.co/t/funding-what-matters-in-the-age-of-ai/25288>
owocki | 2026-06-01 00:26:00 UTC | #1
...
1. Gitcoin’s core mission has always been funding what matters, and our “how” has been building coordination infrastructure for public goods (most notably, QF).
2. We now see the AI transition as the next major public goods challenge: concentrated power, collapsing trust, cognitive dependency, and mass displacement are all coordination failures.
3. Resilience itself is a public good: communities need shared infrastructure to preserve agency, trustworthy information, local livelihoods, and accountable governance.
4. We believe the tools we’ve built for Ethereum public goods funding (QF, grants infrastructure, sybil resistance, community capital allocation) can now be applied more broadly to help society coordinate through the AI transition.
...
owocki | 2026-06-01 00:31:10 UTC | #2

my belief level in this direction is high. this is the right read of the landscape and the right move for gitcoin.

i’m going to put real capital behind it. picking up more GTC in the open market over the coming weeks.

other things i’ve been chewing on:

1\. **rebuild the stewards.** imagining 5-10 new stewards, each with \~500k-1m GTC delegated, who actually grok the AI livelihood problem space and can move at the speed this window demands. the old bench was built for a different gitcoin. the new one needs people who feel the four harms in their bones.

2\. **research groups per resilience frame** (economic, cognitive, epistemic, institutional)**.** each one led by someone already shipping in that space. small, fast, no committees.

3\. **v0 of a resilience funding framework**, public by Q3. opinionated, citable, forkable. the QF playbook took years to legitimize. this window is shorter.

4\. **quadratic funding for the AI displacement movement.** one front door for people who are scared about AI and want to do something (fund it or find out more). one funnel, one message, one place to point them.

5\. **an advisor group, 8-12 people.** who’ve actually built coordination infrastructure or studied displacement at scale. paid in GTC, scoped to 12 months, retired cleanly at the end. no permanent seats.

if you believe in this direction and you hold GTC, consider delegating to kev.eth. i’ll show up. i’ll vote. i’ll explain my votes. and i’ll spend the social capital to recruit the next steward bench around this thesis.

the overton window on AI displacement is open right now. it closes when a new normal sets in. let’s fill it with infrastructure that returns agency, before someone else fills it with something that doesn’t.

disclaimer: this post is for informative purposes only and is not financial advice. this post may contain estimates, may contain errors, and is provided on a best-effort basis. DYOR, do not make any financial decisions based on these posts.

-------------------------

innov8tor3 | 2026-06-08 16:49:50 UTC | #3

This is a serious question, and I feel I’m exploring some relevant foothills, and have previous experience that relates.

So I provided a TLDR response to the post from @owocki  in X, collated using Thread Reader.

I can’t link it here, sadly, or show a screen shot. 😭

It’s only the beginning of a discussion, but I’m hopeful that human ingenuity will do what it always does, and find a way.

Over to @owocki as to how to continue any discussion.
