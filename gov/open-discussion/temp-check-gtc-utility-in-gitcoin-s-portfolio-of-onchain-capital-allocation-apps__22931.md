---
id: 22931
title: "[TEMP CHECK] GTC = Utility in Gitcoin’s portfolio of onchain capital allocation apps"
slug: temp-check-gtc-utility-in-gitcoin-s-portfolio-of-onchain-capital-allocation-apps
category: open-discussion
url: https://gov.gitcoin.co/t/temp-check-gtc-utility-in-gitcoin-s-portfolio-of-onchain-capital-allocation-apps/22931
created_at: 2025-08-13T16:51:21.080Z
last_posted_at: 2025-08-19T12:10:15.307Z
posts_count: 2
views: 1310
like_count: 5
---

# [TEMP CHECK] GTC = Utility in Gitcoin’s portfolio of onchain capital allocation apps

<https://gov.gitcoin.co/t/temp-check-gtc-utility-in-gitcoin-s-portfolio-of-onchain-capital-allocation-apps/22931>
owocki | 2026-07-20 14:59:35 UTC | #1

IMPORTANT - This is a draft direction for Gitcoin 3.0 => 3.3. Digest it, debate it, fork it, make changes. Nothing is official until ratified by [@gitcoin](https://gov.gitcoin.co/u/gitcoin) governance. The post is for informational purposes only. Do not make any financial decisions based off this post.

## \[TEMP CHECK\] GTC in Gitcoin 3.3

**Objective**
The goal for this post is to articulate how GTC could be useful in [Gitcoin 3.3](https://gov.gitcoin.co/t/temp-check-gitcoin-3-3-3-3-an-evolutionary-arena-for-capital-allocation/22680) and receive feedback on its direction from the DAO.

**TLDR**
If ratified: GTC captures utility from every funding mechanism Gitcoin accelerates—GTC is your exposure to utility in the coming wave of onchain capital allocation apps.
...
More more about [Gitcoin 3.3](https://gov.gitcoin.co/t/temp-check-gitcoin-3-3-3-3-an-evolutionary-arena-for-capital-allocation/22680) here.
...
#### 2. Utility in Successful Mechanisms
...
* As the arena’s winners scale, GTC is positioned to participate in the utility—not just as an observer, but as a co-owner of the network.
...
* Bundles Control + utility: GTC holders both govern and benefit from the most advanced funding network in Ethereum.
...
* **Control + Utility Bundled** – GTC uniquely combines governance over a critical funding infrastructure with the ability to capture value as successful mechanisms scale.
...
* **Execution Risk + Uncertain Monetization Process** – We would need to figure out how to become a VC - basically picking which software providers are going to have asymmetric utility and will provide that value back to GTC via tokenization.
...
* ![:white_check_mark:|20x20](upload://govKK4c2tdFCUfOD2w2n5Gwz4lM.png ":white_check_mark:") FOR — Adopt this vision for GTC utility.
* ![:x:|20x20](upload://eBYBGzTvNlIRN5mfqtwZWYh9C1v.png ":x:") AGAINST — Reject the direction; continue with the current approach
* ![:white_circle:|20x20](upload://xVx3U7ySl0zQEemXev3CHfbUhLJ.png ":white_circle:") ABSTAIN — I am neutral or need more information
...
* “GTC - Govern the capital flow. Share the utility.”
...
* “GTC: Influence with utility.”
* “GTC : Drive the arena. Reap the gains.”
* “GTC: Where governance meets gains.”
* “Hold GTC, share utility in the coming capital allocation ecosystem.”
* “GTC: Utility in every allocation.”

-------------------------

Recce | 2025-08-19 12:10:15 UTC | #2
