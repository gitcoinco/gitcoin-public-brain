---
id: 8254
title: "Gitcoin Treasury Vision"
slug: gitcoin-treasury-vision
category: open-discussion
url: https://gov.gitcoin.co/t/gitcoin-treasury-vision/8254
created_at: 2021-08-16T14:54:55.122Z
last_posted_at: 2021-09-22T18:40:29.691Z
posts_count: 4
views: 6130
like_count: 15
---

# Gitcoin Treasury Vision

<https://gov.gitcoin.co/t/gitcoin-treasury-vision/8254>
AcceleratedCapital | 2022-05-28 15:38:59 UTC | #1

**Title:** Gitcoin Treasury Vision
**Authored by Llama DAO Members:** @HelloShreyas, @AcceleratedCapital 
**Posted on:** 8/16/21
...
* **Serving the Public Good.** Gitcoin is focused primarily on building public goods, and so any treasury strategy should be focused on helping “[public goods go up](https://twitter.com/owocki/status/1384861725086916611)”.
...
## Governance, Treasury Processes, Workstreams
...
Toby | 2021-09-06 18:42:32 UTC | #2

@AcceleratedCapital Following up on this. Is this a report or a proposal to produce a treasury management plan? A strategy is desperately needed. Right now we are moving $500k from the treasury into multisigs simply to pay contributors, I imagine a lot of this will be sold off on exchanges which will be bad for token price. We may need to think about Gitcoin Holdings exchanging some of its USD holdings for GTC to get USDC in the dao for paying contributors. What do you guys need to push forward on this? cc @HelloShreyas

-------------------------

AcceleratedCapital | 2021-09-22 06:32:07 UTC | #3

Hi Toby – 

This post is a strategic outline for how to think about the Gitcoin DAO treasury at a high level. We are following this up with an asset management framework that can be used to execute treasury strategy. 

We agree that diversifying partially into stables makes sense from both a working capital management perspective (e.g., funding workstreams and paying contributors) and an asset management perspective (e.g., holding assets with much lower correlation and standard deviation relative to $GTC for diversification purposes). 

We are currently in the process of creating financial reporting and doing some legal work with Gitcoin Holdings on how best to implement these decisions.

-------------------------

vogue20033 | 2021-09-22 18:40:29 UTC | #4

Well said @AcceleratedCapital 

It will be of interest if contributors' payment could be split into 50% **$GTC** & 50% **Stables** (USDC or other stable coins).

There is a probability that the pressure for contributors to sell off their $GTC for stables will be reduced or of no tangible impact on the token price.
