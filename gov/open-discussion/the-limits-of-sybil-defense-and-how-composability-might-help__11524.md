---
id: 11524
title: "The limits of Sybil defense (and how composability might help)"
slug: the-limits-of-sybil-defense-and-how-composability-might-help
category: open-discussion
url: https://gov.gitcoin.co/t/the-limits-of-sybil-defense-and-how-composability-might-help/11524
created_at: 2022-09-17T09:02:15.987Z
last_posted_at: 2022-09-23T14:00:10.479Z
posts_count: 9
views: 4642
like_count: 52
---
...
j-cook | 2022-09-17 09:02:16 UTC | #1
...
tjayrush | 2022-09-17 09:51:12 UTC | #2
...
j-cook | 2022-09-17 10:46:09 UTC | #3
...
tjayrush | 2022-09-18 14:16:44 UTC | #4

[quote="j-cook, post:3, topic:11524"]
...
kyle | 2022-09-18 22:59:04 UTC | #5

[quote="j-cook, post:1, topic:11524"]
One option to overcome this is to break Sybil defense down into composable units that can be tuned and deployed by individual sub-communities instead of trying to construct a Sybil panopticon that works well for everyone. It wil be much easier to construct layered anti-Sybil onion systems for individual subcommunities than trying to tune a single monolithic system to work for everyone.
[/quote]
...
epowell101 | 2022-09-19 18:56:32 UTC | #6
...
lee0007 | 2022-09-21 08:30:49 UTC | #7
...
j-cook | 2022-09-21 09:08:18 UTC | #8
...
porobov_p | 2022-09-23 14:00:10 UTC | #9

Hey @j-cook!

Awesome read! Love the onion idea! And I particularly like that it aligns pretty well with @tjayrush concerns. It leaves a room for tweaking and … friction (A cool helpful term that I adopted while talking with Phillip Sheldrake. Totally recommend reading [his essay](https://generative-identity.org/human-identity-the-number-one-challenge-in-computer-science/). Bends mind in proper ways). Also thanks for describing airdrop farming and “exploits” vs “hacks” in DeFi. Helpful too!

Wanna insert though a short note on *Cost of forgery* and plutocracy. It seems to me that the “Plutocratic tendencies” section relates to “staked identity” which requires that a person stakes money on theirselves or peers ([described in this post](https://gov.gitcoin.co/t/establishing-a-new-process-for-identify-verification-scoring-and-removing-troubled-id-methods/7506/2)). Anyway it makes no sense in case of *Price of forgery* (PoF) or *Cost of forgery* (AFAIK the term got into Gitcoin from [this paper](https://arxiv.org/abs/2008.05300) and then transformed a bit, but ”*Price of forgery*” is how we still call it in Upala, the reason and the difference is also described in the [methodology](https://gov.gitcoin.co/t/benefits-of-using-price-of-forgery-in-gitcoin/11314/2#pof-and-pool-size-relation-8)). Explaining my point further.

> “rational actors are disincentivized from attacking a system”
> 

The [methodology of Price of forgery measurement](https://gov.gitcoin.co/t/benefits-of-using-price-of-forgery-in-gitcoin/11314/2?u=porobov_p) does recommend a setup of an environment where conditions slowly approach the point of disincentivizing the rational actor from attacking the system (to be specific attacking matching funds). But disincentivizing is not the goal, the goal is measurement. 
...
**PoF makes plutocratic tendencies neither stronger, nor weaker. It is a measurement tool.** Which I believe could be a very useful one in the fraud detection pipeline. And which could be easily integrated into the fraud detection 🧅.

If you wanna dive deeper check out this [Price of forgery measurement campaign](https://gitcoin.co/grants/7602/price-of-forgery-measurement-campaign) grant for details. Also check out [Upala dashboard](https://www.notion.so/UPALA-DASHBOARD-a46d88209ecb4a4cabf1560acc8673a2) and [article on EthResearch on price of forgery](https://ethresear.ch/t/price-of-forgery-digital-identity-measuring-human-uniqueness-score-in-dollars/8328). I’m working hard to deliver an up-to-date documentation. And best of all let’s chat ([my twitter](https://twitter.com/porobov_p)).
