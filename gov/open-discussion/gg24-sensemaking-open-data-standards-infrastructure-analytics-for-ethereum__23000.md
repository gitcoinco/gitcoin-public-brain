...
slug: gg24-sensemaking-open-data-standards-infrastructure-analytics-for-ethereum
category: open-discussion
url: https://gov.gitcoin.co/t/gg24-sensemaking-open-data-standards-infrastructure-analytics-for-ethereum/23000
created_at: 2025-08-15T05:08:15.761Z
last_posted_at: 2025-08-25T12:42:43.672Z
posts_count: 4
views: 1609
like_count: 6
---
...
<https://gov.gitcoin.co/t/gg24-sensemaking-open-data-standards-infrastructure-analytics-for-ethereum/23000>
rohit | 2025-08-15 05:13:23 UTC | #1
...
![|561x344](upload://5feV33YiSbAOfNKhCDgyb9hpWs0.jpeg)
...
![|624x385](upload://wLjnMOcu0xoC5CR5iHOBF00KSaq.jpeg)
...
![|624x323](upload://dQDW0cV77xsfDOzVEpz8F88QHfa.jpeg)
...
owocki | 2025-08-19 05:48:48 UTC | #2
...
## Prepared for rohit et al. re: "Open Data Standards, Infrastructure & Analytics for Ethereum"
...
**TITLE**
Open Data Standards, Infrastructure & Analytics for Ethereum

**AUTHOR**
rohit (with inputs from Carl Cervone, David Gasquez, Rashmi Abbigeri, Sam McCarthy, Sov, Umar Khan)
...
Ethereum's open, public data is underutilized because most usable layers remain siloed behind proprietary platforms. This proposal suggests creating a funding domain dedicated to open data infrastructure—covering explorers, analytics, standards, and metrics—to enable transparency, coordination, and evidence-based decision-making across L1 and L2 networks.

### Proposers

**rohit**, supported by the input of **Carl Cervone, David Gasquez, Rashmi Abbigeri, Sam McCarthy, Sov, Umar Khan**—some of whom likely have relevant domain or ecosystem knowledge. Specific credentials are not detailed in the post.
...
Ethereum's rapid scale through L2s has fractured data visibility. While raw data is public, meaningful layers (dashboards, explorers, analytics) depend on proprietary systems. This hinders coordination, transparency, and data-driven action when decisions rely on anecdotal signals.

### Solution

Create an open data infrastructure funding domain addressing three core 2025 opportunities: unified L1–L2 visibility; institutional DeFi legitimacy; transparent open‑source funding. Support explorers, metrics, standards, and analytics to close coordination gaps and bolster credibility.

### Risks

Execution risks include:

* Lack of clarity around who will build or lead the funded infrastructure.
* Potential duplication of existing projects; unclear how funding will coordinate efforts rather than dilute them.
* No identified outside funding or partners yet; reliance on Gitcoin alone increases risk.
* Uncertainty around timeline, milestones, and deliverables.
* Absence of named domain experts or clear project roadmaps.
...
No mention of outside funding or co‑funders in the proposal.

---

## Why Gitcoin?

Gitcoin can provide catalytic capital and domain allocation, aligning with its mission of supporting public goods. No other platform offers the same combination of community-driven, open grants targeted at infrastructure; Gitcoin is well-suited to fill this gap.
...
| - | ------------------------------------------------ | ----------- | ----------------------------------------------------------------------------------------- |
| 1 | Problem Focus – real, urgent, avoids solutionism | 2           | Clearly frames a real systemic coordination problem caused by scaling.                    |
| 2 | Credible, High‑leverage, Evidence‑Based Approach | 2         | The root idea is high‑leverage, for ethereum.|
| 3 | Domain Expertise                                 | 2         | Contributors are named, but their credentials or domain authority are not clear.          |
| 4 | Co‑Funding                                       | 0           | No outside funding mentioned.                                                             |
| 5 | Fit‑for‑Purpose Capital Allocation Method        | 1           |mechanisms and structure are vague, but this is a group thats run campaigns like this before.                 |
| 6 | Execution Readiness – deliver by October         | 1         | No roadmap or team clarity; tight timeline questionable.                                  |
| 7 | Other – overall vibe and originality             | 2           | Strong conceptual framing; needs more substance and execution detail.                     |

**Total Score:** 10 / 14
**Confidence in score:** 60%
...
* Clarify who will lead execution: name projects or teams, define deliverables and milestones.
* Define and secure co‑funding or partnerships; without this, sustainability and scale are doubtful.

### Minor

* Provide examples of potential use‑cases or pilot projects to validate feasibility.
* Identify and describe domain experts or steering group to lend credibility.
* Include a basic timeline (e.g. October 2025 deliverable like a prototype or standards draft).
...
This funding domain tackles a foundational coordination failure. Open data infrastructure is high‑impact; analogous earlier successes (e.g. Blockscout, DefiLlama) show what’s possible. Standardizing data access would empower builders, institutions, and researchers. Gitcoin can play a unique role enabling open data as Ethereum’s differentiator.

### Against

The proposal is too conceptual without execution detail. Lack of named partners, funding, or teams makes it unclear if this can deliver. Without serious planning, it may end up as another report instead of infrastructure.
...
**Rose**
The framing is powerful and timely. Emphasizes transparency, coordination, and Ethereum’s core differentiator: open, verifiable data. This proposal targets a high‑impact, foundational problem.

**Thorn**
Execution risk is high due to absence of team, timeline, and funding. Without clarity on who will build what, it’s easy for ambition to outstrip capacity.

**Bud**
With clearer structure and committed leadership, this could mature into a defining Gitcoin domain—leading to ecosystem-wide data standards, better tooling, and more accessible metrics. A good next step would be forming a working group to pilot specific components.

---

## Feedback

Let me know if any of the above is off, or if you’d like me to adjust the tone or scope. Happy to iterate further.

---

## Research Notes

* No funding or partners identified; a gap that may limit impact and execution.
* Further diligence: identify existing open‑data projects, their funding status, teams, and explore potential collaborators (e.g. The Graph, Blockscout, L2Beat).

-------------------------

deltajuliet | 2025-08-19 22:21:33 UTC | #3

Thanks @rohit for putting this forward. I’m reviewing all GG24 proposals against [my steward scorecard](https://gov.gitcoin.co/t/gg24-domain-proposal-voting-scorecards/23016/5?u=deltajuliet).

---

### ✅ Submission Compliance
- Meets length and covers all required sections  
- Domain info present, but no confirmed experts yet  
- **Compliant**
...
|----------|-------|-------|
| Problem Clarity | 2 | Frames the risk well: Ethereum scaling → fragmented data → coordination failure |
| Sensemaking Approach | 2 | Uses ecosystem research, cross-chain comparisons, taxonomy |
| Gitcoin Fit | 2 | Gitcoin is the right convener/funder for this space |
| Fundraising Plan | 1 | No hard co-funders identified yet |
| Capital Allocation Design | 2 | Retro + metrics-enabled model is thoughtful and pragmatic |
| Domain Expertise | 1 | Strong categories named, but no confirmed stewards |
| Clarity & Completeness | 2 | Structured and thorough |
| Gitcoin Support Required | 1 | Would require Gitcoin to scaffold governance and convene experts |

---

### 🚩 Gaps
- No confirmed domain stewards or experts  
- No outside capital secured → Gitcoin would be carrying the full load at first  
- Needs concrete roadmap/milestones; right now it’s more strategic vision than execution plan  

---

### 📌 Next Step
This is a strategically important proposal: open data is Ethereum’s credibility layer. It should move forward **if** a working group and outside funding commitments materialize.

-------------------------

sepu85 | 2025-08-25 12:42:43 UTC | #4

Thanks for this proposal on **Open Data Standards & Analytics** — this is a cornerstone topic for the ecosystem, and it’s encouraging to see attention on infrastructure that makes impact more measurable and trustworthy.

In our [proposal](https://gov.gitcoin.co/t/gg24-sensemaking-report-at-pre-post-grant-coordination-from-allocation-to-alignment-accountability/21711), instead of proposing a domain, we’re exploring whether **CollabBerry’s contributor-level allocation and accountability tooling** could serve across domains as a complementary mechanism.

What connects strongly with your work here is the importance of **data integrity**. Just as open standards create transparency across ecosystems, CollabBerry experiments with transparency inside projects — using continuous peer-to-peer assessments to generate a **reputation layer** at the contributor level. This reputation data informs more fair and accountable fund distribution once grants reach projects.

We see this as a possible complement to your vision: where open data standards make funding flows measurable at the ecosystem level, CollabBerry ensures that *internal allocation data* (who contributed, how resources are shared) is equally transparent and trustworthy.

Do you see contributor-level accountability data as relevant for expanding the scope of open data infrastructure in Ethereum?
