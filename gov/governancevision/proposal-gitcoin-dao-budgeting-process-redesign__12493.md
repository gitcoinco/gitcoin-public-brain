---
id: 12493
title: "Proposal: Gitcoin DAO Budgeting Process Redesign"
slug: proposal-gitcoin-dao-budgeting-process-redesign
category: governancevision
url: https://gov.gitcoin.co/t/proposal-gitcoin-dao-budgeting-process-redesign/12493
created_at: 2023-01-04T18:59:36.083Z
last_posted_at: 2023-01-18T15:26:51.622Z
posts_count: 22
views: 4327
like_count: 69
---
...
<https://gov.gitcoin.co/t/proposal-gitcoin-dao-budgeting-process-redesign/12493>
safder | 2023-01-05 01:13:52 UTC | #1
...
1. I can easily see how this workstream’s work in the past month fits within our [**Purpose and Essential Intents**](https://gov.gitcoin.co/t/update-gitcoindaos-adopted-purpose-and-essential-intents/10984).
...
The scores = the average rating received (between 1-5) for each of the components, with a separate Contributor and Steward scores. These are updated on the Workstreams tab on [https://www.daostewards.xyz/](https://www.daostewards.xyz/), or other easy-to-find location.
...
![Screen Shot 2022-12-13 at 11.16.35 PM|690x446, 75%](upload://2f13teC0heum2HilJOyNOqPc7XZ.jpeg)
...
![Solarpunk|690x460, 50%](upload://vDJv4Goy34VDF30LPjYkN9KjMHi.jpeg)
...
4. The DAO is also interested in an alternative (likely post-protocol launch) exploration into shorter budget cycles and [thinner workstreams](https://gov.gitcoin.co/t/discussion-a-hypothesis-thin-workstreams-lead-to-better-outcomes/9975). Is there a way to reconcile this and the composable approach to budgeting described above? 
...
a33titude | 2023-01-04 23:16:01 UTC | #2
...
![dc496a33ae0fc37e79eeefb187e1aa9d|690x390](upload://95MkL8D43OE2p9QBZFQa7NJSUyn.webp)

-------------------------

kevin.olsen | 2023-01-05 09:26:09 UTC | #3

This was my first reaction as well. I took a bit of time here to try and diagram in [Miro](https://miro.com/app/board/uXjVP1RbkVM=/?share_link_id=848211564428) 

![image|690x374](upload://mRyeKa5xupZJPg0CUra1dxD1fRp.png)
...
shawn16400 | 2023-01-05 12:40:31 UTC | #4

[quote="safder, post:1, topic:12493"]
By **modularizing** the budgeting process, we make it much easier to work with and refine each piece. This proposal includes all three components.
[/quote]
...
[poll type=multiple results=always min=1 max=3 chartType=bar]
...
shawn16400 | 2023-01-05 13:14:09 UTC | #5
...
shawn16400 | 2023-01-05 13:06:34 UTC | #6
...
shawn16400 | 2023-01-05 13:22:43 UTC | #7
...
Maxwell | 2023-01-05 16:31:51 UTC | #8
...
safder | 2023-01-05 19:46:23 UTC | #9
...
[quote="shawn16400, post:4, topic:12493"]
I know this proposal works in concert across the three areas, but I would see value in breaking this into two components: 1) budgeting and 2) performance evaluation. I think “forecasting” is confusing strategic planning / goal / road map development and that is a separate process - which also needs work, but separately.
[/quote]
...
[quote="shawn16400, post:5, topic:12493"]
Do these proposed questions integrate with the DAO Health Survey set to launch next week?
[/quote]
...
[quote="shawn16400, post:6, topic:12493"]
Part of me likes 6 months, but the overachieving-ambitious part of me (its a small part) wants to move to a jobshop project portfolio design where funding is allocated by project, not by arbitrary timefences. But, might be for later. I like 6.
[/quote]
...
[quote="shawn16400, post:7, topic:12493"]
Additionally - I think you need to bring this to the Steward Council as a topic and get input from from that council of web3 wizards. It may not be a converging exercise, but if you scope this right, you will get some great input. Next free agenda period is Jan 23 - but we can call a ad-hoc meeting of those with relevant experience to review the topic sooner.
[/quote]
...
[quote="Maxwell, post:8, topic:12493"]
Going deep on one specific part here, I worry about the rhetoric regarding tying spending to GTC price. I know I’m somewhat a heretic with my belief that token price has nothing to do with performance, but I’m becoming increasingly convinced that token price is a *terrible* indicator for success, especially when the token is a governance token. This [tweet from Messari](https://twitter.com/messaricrypto/status/1583261803550691329?s=46&t=R5IHTokdONiKLBgYgifbSw) about Yearn’s ATH TVL and ATL token price is something I think about often.
[/quote]
...
shawn16400 | 2023-01-06 03:12:41 UTC | #10


[quote="safder, post:9, topic:12493"]
[quote="shawn16400, post:5, topic:12493"]
Do these proposed questions integrate with the DAO Health Survey set to launch next week?
[/quote]
...
Sorry - did not mean to distract from the relevant passage in the proposal - which I forgot what it was and can't find the original reference because is was like 15 pages ago.  For reference, see "I encourage proposals to be smaller in scope to in order to:"  somewhere above :)  

At this point, I am too long on this post and will try to pick up the rest later.

-------------------------

annika | 2023-01-09 05:56:06 UTC | #11
...
shawn16400 | 2023-01-09 14:47:26 UTC | #12
...
(see "I encourage proposals to be smaller in scope to in order to" above) :)
...
ccerv1 | 2023-01-09 14:50:53 UTC | #13
...
Keeping them parallel also helps prevent the system from reducing a la [Goodhart's law](https://en.wikipedia.org/wiki/Goodhart%27s_law) to: monthly scorecards --> votes of confidence --> resource allocation decisions.
...
OmnistratMatt | 2023-01-09 22:33:01 UTC | #14
...
If you are looking for feedback, I'll offer mine. This is another approach you can look at after implementing this current effort. Here is a quick [video](https://bit.ly/34S6Tim) (<5min) that shows this approach.
...
![Gitcoin 2022 Plan in Omnistrat|132x500](upload://rImaxWdNElerw2fzKlv4nmoNjjc.jpeg)

-------------------------

Lyle_Loves_Gitcoin | 2023-01-10 03:05:25 UTC | #15
...
Vega | 2023-01-10 03:46:16 UTC | #16

[quote="safder, post:1, topic:12493"]
1. **********************Opaqueness to Stewards outside the organization:********************** With very little context on workstream projects (and little incentive for workstreams to increase context-sharing), Stewards are often left in the dark on the how/why of work completed at the DAO - leaving them to make resource allocation decisions without a complete picture.
[/quote]

Thank you for acknowledging this point!

[quote="shawn16400, post:6, topic:12493"]
where funding is allocated by project
[/quote]
...
[quote="a33titude, post:9, topic:12442"]
There is no competition or market for DAO leadership.
...
Pop | 2023-01-10 10:26:21 UTC | #17
...
shawn16400 | 2023-01-10 14:09:16 UTC | #18
...
epowell101 | 2023-01-11 17:53:54 UTC | #19
...
abigailcarlson | 2023-01-13 13:38:21 UTC | #20
...
safder | 2023-01-14 02:50:00 UTC | #21
...
To respond to your concerns on this component @epowell101: this won't replace OKRs being used to create targets at workstream and individual levels, however performance will not be evaluated against these OKRs (this is a [known problem](https://www.whatmatters.com/articles/should-you-connect-okrs-and-compensation-spoiler-alert-no) when using OKRs for performance evaluation).

[quote="shawn16400, post:18, topic:12493"]
Have you been able to look to existing approaches to see if there might be solutions that we could fork?
[/quote]
...
However, there is plenty of innovation in budgets in "web2" Teal organizations; the framework I took inspiration from for this process is [Beyond Budgeting](https://www.bcg.com/en-ca/publications/2021/the-future-is-beyond-budgeting) - you can find a lot of high-quality academic research on this framework if you're interested in deep-diving.

-------------------------

epowell101 | 2023-01-19 16:23:33 UTC | #22
