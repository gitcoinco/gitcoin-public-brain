---
id: 10438
title: "GIA Rewards OKR Report"
slug: gia-rewards-okr-report
category: governancevision
url: https://gov.gitcoin.co/t/gia-rewards-okr-report/10438
created_at: 2022-04-28T09:17:33.128Z
last_posted_at: 2022-04-28T15:05:37.943Z
posts_count: 2
views: 4728
like_count: 24
---

# GIA Rewards OKR Report

<https://gov.gitcoin.co/t/gia-rewards-okr-report/10438>
vogue20033 | 2023-04-06 16:35:01 UTC | #1

## Background

Credible neutrality is necessary for a community to grow. [Rawls](https://en.wikipedia.org/wiki/John_Rawls) has shown that participants are more likely to accept the outcomes of an election if they think the process is legitimate and fair. As we build the first digital democracies, how might we improve the legitimacy, credible neutrality, and sustainability of the new, internet-based, democratic systems?
...
![](upload://mLoTvGKK5nkEomVjFl3v4dnRvqc.jpeg)
...
1) the outcomes from the less trusted junior reviewers are reinforced by a second more experienced reviewer, enhancing overall trust in the grant evaluation
   
2) Feedback passed from level-2 back to level-1 stimulates learning, meaning level-1 reviewers can become level-2 reviewers more quickly, growing the pool of "high-trust" reviewers
    
3) The signal to noise ratio for the level-2 reviewers is improved because level-1 reviewers sift out the obviously invalid grants
   
4) There are opportunities to develop trust metrics by monitoring how many times level-1 reviewers agree with level-2 reviewers. Some benchmark trust score could elevate a reviewer from level-1 to level-2

5) The simple model topology allows for additional layers where more trust is needed (e.g. level-2 reviewers reviewed by level-3 reviewers)

6) The cost per grant is fixed and easy to calculate.

**Cost of Hierarchical Model**
c<sub>1</sub>+c<sub>1</sub>
`cost` = c<sub>1</sub>+c<sub>1</sub>

where c<sub>1</sub> = cost for a level-1 reviewer, c<sub>2</sub> = cost for a level-2 reviewer
...
![](upload://tj3AC2yQj7LfRJAdTQNszXIAwpc.jpeg)
...
In a 3-reviewer pool where the three reviewers have trust levels t<sub>1</sub>, t<sub>2</sub> and t<sub>3</sub> respectively, the trust level of the model would be


<center> t<sub>1</sub>t<sub>2</sub>t<sub>3</sub> + t<sub>1</sub>t<sub>2</sub> (1-t<sub>3</sub>) +t<sub>1</sub>(1-t<sub>2</sub>)t<sub>3</sub>+(1-t<sub>1</sub>)t<sub>2</sub>t<sub>3</sub> <center>

This expression comes from applying basic probability rules and can be seen as 
...
![](upload://sU88QT23M3CISszfqrYkT4ANEqr.png)
...
DisruptionJoe | 2022-04-28 15:05:37 UTC | #2

Thanks for your OKR report @vogue20033 BFA! The work here is excellent. This team performed admirably on their OKRs. I'm excited to see what we will accomplish next season!
