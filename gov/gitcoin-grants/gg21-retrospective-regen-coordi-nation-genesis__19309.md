---
id: 19309
title: "[GG21 Retrospective] Regen Coordi-Nation Genesis 🌱"
slug: gg21-retrospective-regen-coordi-nation-genesis
category: gitcoin-grants
url: https://gov.gitcoin.co/t/gg21-retrospective-regen-coordi-nation-genesis/19309
created_at: 2024-09-04T14:59:25.177Z
last_posted_at: 2024-09-11T12:17:26.359Z
posts_count: 9
views: 4348
like_count: 16
---
...
<https://gov.gitcoin.co/t/gg21-retrospective-regen-coordi-nation-genesis/19309>
MontyMerlin | 2024-09-04 15:04:23 UTC | #1

![Regen Coordi-Nation Banner](upload://k5GujnmSCliWpj8TxkoprQjo2M0.jpeg)
...
![Reegn Tips x Celo GG21|500x500, 50%](upload://es829HMbx4m6RSj4YYFV2V1GaXP.png) |![Regen Quadratic Multiplier|504x500, 50%](upload://90Ix51luU26dnebLVJkIeTpAoPI.jpeg)
...
![Regen Coordi-Nation GG21 Matching Results](upload://ph9FCG1v8ixSzBQuD9srS8KBRde.png)
...
Decentralizedceo | 2024-09-04 15:31:14 UTC | #2

This is a very detailed report and answers a lot of questions! Thank you for this. I am looking forward to the next steps, especially the "Impact Measurement and Tracking."

-------------------------

Oba-One | 2024-09-05 01:12:25 UTC | #3

Great in depth report, one question I have is around the decision to use Connection-oriented cluster-matching (COCM) and the timing of this decision? 

Being an admin on the Greenpill side of things for this round the team and I were not aware this would be factored in, maybe that was intentional would like to get clarity. 

Also another question is how onchain are the results, if not it would be nice to see an attestation where the results are attested for every round. Some data can live offchain stored on IPFS like the report PDF and metrics like the formula chosen, notes, etc can be other properties in the attestation schema.

-------------------------

MontyMerlin | 2024-09-05 09:42:15 UTC | #4

Hey hey Afo. 

Model-Based Detection + Connection-oriented cluster-matching (COCM) is the default and recommended strategy for Sybil Defense in Gitcoin. To have not used Model-Based Detection would mean having to do our own Sybil analysis in house or use Gitcoin Passport's manual stamps (which are also not live on Celo). If we were to choose standard QF over COCM I think that would have required a well defined reason, rather than the other way around. 

Regarding onchain results, you can see the payout transaction here: https://celoscan.io/tx/0x11eeb9703f976c8caa1b631f353b29217a57205ebd9eac630d7e1e13e86ca8b6 but maybe you are looking for something more? If so, @umarkhaneth and others from Gitcoin might be able to provide more clarity.

All the best

-------------------------

Oba-One | 2024-09-05 19:33:40 UTC | #5

Thanks for the quick response, how about the timing of the decision?

-------------------------

MontyMerlin | 2024-09-09 10:04:56 UTC | #6

Regarding timing, using COCM was always the plan given it being the default and recommended strategy from Gitcoin however maybe this could have been stated in the original proposal so that everyone was aware from the onset. Did you have any issues or concerns with the COCM results or curious as to the purpose of inquiry here? 

We also had a very short amount of time between the proposal getting the greenlight from Gitcoin and the round taking place, if we had had more time it could have been good to have taken more time to communicate and co-create with a wider set of stakeholders. I am thinking about the potential for a joint regular/monthly Regen Coordi-Nation community call with ReFi DAO, GreenPill and CeloPG - hopefully this could be an opportunity to discuss things like this further!

-------------------------

MontyMerlin | 2024-09-09 10:24:46 UTC | #7

Also got this response from @umarkhaneth on Telegram:

*"the results are onchain in two senses:*
*1. the obvious: ofc the actual txs took place onchain*
*2. the hidden: the file you uploaded to manager gets pinned on ipfs and the cid is stored onchain*

*but it may indeed be very cool to generate an attestation with more information like the mechanism"*

-------------------------

MontyMerlin | 2024-09-09 11:43:37 UTC | #8

FYI there is also some interesting analysis from Open Civics @omniharmonic on their reflections on COCM, see here: https://opencivics.substack.com/p/collaborative-research-round-03-insights

-------------------------

MathildaDV | 2024-09-11 12:17:26 UTC | #9

Great retrospective, @MontyMerlin! Thank you for participating in GG21 and sharing your insights and learnings in such an in-depth way. 

[quote="MontyMerlin, post:1, topic:19309"]
**Timing and Application Process**: The short turnaround time between the community round approval and the round going live created challenges, particularly with our slightly longer application process, which prevented some grantees from applying in time. **Solution**: In the future, allowing more time for communications and preparations before the round begins would benefit all participants and ensure smoother operations.
[/quote]
Heard you here! Timing for GG rounds this year has been tricky, and with the prolonged governance process around Community Rounds, it adds an increase pressure on timings. This is changing in 2025, however! So hold tight.

Really appreciate your insights to the RegenTips experiment. I think there is potential to scale this partnership with Gitcoin and GG rounds as a whole moving forward. I loved that you also experimented with Signal Boosting! Curious, did you promote who was signal boosting and did you have them share their donations on social channels? I might've missed this!
...
* Overall Program: 4.14
[/quote]
Feedback is so important within a "retrospective" stage of a round, so I'm very glad to see this come to life! I'm thinking we should probably make this a mandatory for all rounds participating. 

Feature requests have also been recorded, thank you again!
