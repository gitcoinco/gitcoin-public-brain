---
id: 24936
title: "GG24 Interop Round Retrospective"
slug: gg24-interop-round-retrospective
category: gitcoin-grants
url: https://gov.gitcoin.co/t/gg24-interop-round-retrospective/24936
created_at: 2025-12-12T18:02:02.433Z
last_posted_at: 2025-12-14T06:37:21.228Z
posts_count: 2
views: 456
like_count: 6
---
...
<https://gov.gitcoin.co/t/gg24-interop-round-retrospective/24936>
rohit | 2025-12-12 18:09:55 UTC | #1
...
The Interop Standards, Infrastructure & Analytics domain was established to address a growing coordination risk in Ethereum’s multi-chain evolution. As rollups, L2s, and application-specific chains proliferate, interoperability, shared standards, and credible data become essential public goods. This round existed to fund the open infrastructure, analytics, and early pilots needed to make interoperability practical and measurable, with a specific focus on supporting adoption of the [Open Intents Framework](https://efdn.notion.site/The-Open-Intents-Framework-permissionless-cross-chain-interop-to-all-chains-29cd9895554181e2966fe6585980ca9b) (OIF) as a foundational standard. Success was defined by surfacing high-alignment builders, generating clear signals on where interoperability gaps exist, and creating an evidence base that could guide larger, follow-on investments beyond a single funding cycle.

## Round Design and Mechanism

The Interop Standards, Infrastructure & Analytics round was run as a curated [Quadratic Funding (QF) round](https://giveth.io/qf-archive/gg24isia) during GG24 to combine broad community signal with targeted domain stewardship. QF was chosen to surface projects with genuine, distributed demand across the Ethereum ecosystem, rather than concentrating influence among a small set of large donors. This was especially important for interoperability and open data work, where impact is ecosystem-wide but often under-monetized and under-recognized by traditional funding models.

![f83fc31d14dedec7ad5771649bf80610b2970fb7_2_774x750|516x500, 75%](upload://hlakmnH5Z1ktWB6UUCRUNQeUnw6.png)
...
The round was operated in partnership with Giveth, using its QF infrastructure and cluster-based sybil resistance, with Celo supporting the matching pool. This setup balanced accessibility for donors across multiple networks with safeguards to preserve signal quality. The timing of the round reflected a broader ecosystem inflection point: OIF is reaching closer to [production readiness](https://blog.ethereum.org/2025/08/29/protocol-update-003), multi-chain complexity is accelerating, and funders need clearer signals on where early interoperability investments could unlock the highest leverage. The design aimed to meet that moment by pairing community discovery with domain-informed curation, making interoperability fundable, visible, and actionable at the right time.

## Participation Snapshot

Click [here](https://gov.gitcoin.co/t/gg24-update-inside-the-interop-standards-infra-analytics-round/24749) for a deep dive into the five layers of interoperability and the grantees building those layers today. See [this](https://gov.gitcoin.co/t/gg24-oss-quadratic-funding-results/24782#interop-standards-infra-and-analytics-5) post by @[karmaticacid](https://gov.gitcoin.co/u/karmaticacid) for details on the quadratic funding results hosted on the Giveth platform.

![cf1a5b3c52c9b38bd9ae054363ca44bd399087a5_2_1380x776|690x388](upload://bWs7x1q7vIIwnhdpC5JiFjJY76m.jpeg)
...
![Screenshot 2025-12-12 at 10.59.31 PM|690x339](upload://lO09ppYT8hh9VTQAbw7iQXHy8Fc.png)
...
free2ride19 | 2025-12-14 06:37:21 UTC | #2

Okay 🆗 an area to build on interop
